...
#
#     if selected_model:
#         # Map dataset paths based on the selected model
#         if selected_model == 'Robust Covariance Model':
#             testx_path = "assets/testx.npy"
#             testy_path = "assets/testy.npy"
#         elif selected_model in ['K means', 'PCA K means']:
#             testx_path = "assets/testx_scaled.npy"
#             testy_path = "assets/testy_scaled.npy"
#         else:
#             testx_path = "assets/testx.csv"
...
def display():
    ...
    st.title("Model Metrics and Analysis")

    # Dropdown for model selection
    selected_model = st.selectbox("Choose a model for metric analysis", list(model_choices.keys()))
    ...
    if selected_model:
        ...
        try:
            ...
            st.title(f"{selected_model} Metrics and Analysis")
            # Display metrics
            model_vis.display_metrics(selected_model, testy, y_pred)
            # Show confusion matrix
            model_vis.plot_confusion_matrix(testy, y_pred, selected_model)
            # Plot ROC curve
            model_vis.plot_roc_curve(testy, y_pred, selected_model)
            # Plot precision-recall curve
            model_vis.plot_precision_recall_curve(testy, y_pred, selected_model)
            # Visualize anomalies
            model_vis.visualize_anomalies(testx, y_pred, selected_model)
